...
var cal1, cal2;
var index = 0; limit = 5000;
/*
 *mode1: limit 5000 without paging
 *mode2: limit 1000 with paging
*/
var mode = 'mode1';
if (mode === 'mode2') {
    limit = 1000;
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (type.indexOf("application/json") === 0) {
                ...
                if (queryType === 'query') {
                    ...
                    console.log('total  : ' + json.total + ', limit :'+limit);
                    if (json.total) {
                        showPage(json.total);
                    }
                    ...
                    if (json.range) {
                        if(mode === 'mode1'){
                            range = $('#mac').val() + '_' + json.range;
                        }else if ($('#codici_transazioni')) {
